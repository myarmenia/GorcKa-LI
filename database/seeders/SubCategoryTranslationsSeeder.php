...
class SubCategoryTranslationsSeeder extends Seeder
{
    ...
    'name' => 'Animated videos for advertising and presentations'
        ...
        //djbhsbhdbshcbhjdsbchjsdbhcbdsbchjdbcbhdsbcbdjbchdsbhbhbhsbcbdsjcbhjbdchjbdsbcjhds
        [
        'sub_category_id' => 104,
        'lang' => 'am',
        'name' => 'Հանդիսություններ'
        ],
        [
        'sub_category_id' => 104,
        'lang' => 'ru',
        ...
        'sub_category_id' => 105,
        'lang' => 'am',
        'name' => 'Վիդեո և ֆոտո ծառայություններ'
        ],
        [
        'sub_category_id' => 105,
        'lang' => 'ru',
        'name' => 'Видео и фото услуги'
        ],
        [
        'sub_category_id' => 105,
        'lang' => 'en',
        ...
        'sub_category_id' => 107,
        'lang' => 'am',
        'name' => 'Սնունդ և քեյթրինգ'
        ],
        [
        'sub_category_id' => 107,
        'lang' => 'ru',
        'name' => 'Eда и кейтеринг'
        ],
        [
        'sub_category_id' => 107,
        'lang' => 'en',
        ...
        'sub_category_id' => 108,
        'lang' => 'en',
        'name' => 'All For New Year'
        ],
        [
        'sub_category_id' => 109,
        'lang' => 'am',
        'name' => 'Միջոցառումների և տոնակատարությունների այլ ծառայություններ'
        ],
        [
        'sub_category_id' => 109,
        'lang' => 'ru',
        'name' => 'Остальные услуги для мероприятий и праздников'
        ],
        [
        'sub_category_id' => 109,
        'lang' => 'en',
        'name' => 'Other Services for Events and Celebrations'
        ],
        [
        'sub_category_id' => 110,
        'lang' => 'am',
        'name' => 'Օտար լեզուների պարապմունքներ'
        ],
        [
        'sub_category_id' => 110,
        'lang' => 'ru',
        'name' => 'Занятия по иностранному языку'
        ],
        [
        'sub_category_id' => 110,
        'lang' => 'en',
        ...
        'sub_category_id' => 111,
        'lang' => 'am',
        'name' => 'Դպրոցական և բուհական առարկաներ'
        ],
        [
        'sub_category_id' => 111,
        'lang' => 'ru',
        ...
        'sub_category_id' => 112,
        'lang' => 'am',
        'name' => 'Մասնագիտական վերապատրաստում'
        ],
        [
        'sub_category_id' => 112,
        'lang' => 'ru',
        ...
        'sub_category_id' => 113,
        'lang' => 'am',
        'name' => 'Երաժշտական ​​և թատերական կրթություն'
        ],
        [
        'sub_category_id' => 113,
        'lang' => 'ru',
        'name' => 'Музыкальное и театральное образование'
        ],
        [
        'sub_category_id' => 113,
        'lang' => 'en',
        'name' => 'Music and Theater Education'
        ],
        [
        'sub_category_id' => 114,
        'lang' => 'am',
        'name' => 'Երեխայի զարգացում'
        ],
        [
        'sub_category_id' => 114,
        'lang' => 'ru',
        ...
        'sub_category_id' => 115,
        'lang' => 'ru',
        'name' => 'Занятия спортом и танцами'
        ],
        [
        'sub_category_id' => 115,
        'lang' => 'en',
        'name' => 'Sports and Dancing Classes'
        ],
        [
        'sub_category_id' => 116,
        'lang' => 'am',
        ...
        'sub_category_id' => 117,
        'lang' => 'am',
        'name' => 'Գեղարվեստ և Նկարչություն'
        ],
        [
        'sub_category_id' => 117,
        'lang' => 'ru',
        'name' => 'Занятия искусством и рисованием'
        ],
        [
        'sub_category_id' => 117,
        'lang' => 'en',
        'name' => 'Art and Drawing Education'
        ],
        [
        'sub_category_id' => 118,
        'lang' => 'am',
        'name' => 'Մաքրման ծառայություններ'
        ],
        [
        'sub_category_id' => 118,
        'lang' => 'ru',
        ...
        'sub_category_id' => 119,
        'lang' => 'am',
        'name' => 'Կենցաղային տեխնիկայի վերանորոգում'
        ],
        [
        'sub_category_id' => 119,
        'lang' => 'ru',
        ...
        'sub_category_id' => 123,
        'lang' => 'am',
        'name' => 'Ֆինանսներ և հաշվապահություն'
        ],
        [
        'sub_category_id' => 123,
        'lang' => 'ru',
        ...
        'sub_category_id' => 125,
        'lang' => 'am',
        'name' => 'Թարգմանություն և տեքստեր'
        ],
        [
        'sub_category_id' => 125,
        'lang' => 'ru',
        'name' => 'Переводы и тексты'
        ],
        [
        'sub_category_id' => 125,
        'lang' => 'en',
        ...
        'sub_category_id' => 126,
        'lang' => 'am',
        'name' => 'Իրավաբանական ծառայություններ'
        ],
        [
        'sub_category_id' => 126,
        'lang' => 'ru',
        ...
        'sub_category_id' => 127,
        'lang' => 'am',
        'name' => 'Համակարգչային ծառայություններ'
        ],
        [
        'sub_category_id' => 127,
        'lang' => 'ru',
        ...
        'sub_category_id' => 128,
        'lang' => 'am',
        'name' => 'Էլեկտրոնիկայի վերանորոգում'
        ],
        [
        'sub_category_id' => 128,
        'lang' => 'ru',
        ...
        'sub_category_id' => 130,
        'lang' => 'am',
        'name' => 'Կոսմետոլոգիա և դիմահարդարում'
        ],
        [
        'sub_category_id' => 130,
        'lang' => 'ru',
        'name' => 'Косметология и макияж'
        ],
        [
        'sub_category_id' => 130,
        'lang' => 'en',
        ...
        'sub_category_id' => 131,
        'lang' => 'am',
        'name' => 'Մատնահարդարման և ոտնահարդարման ծառայություններ'
        ],
        [
        'sub_category_id' => 131,
        'lang' => 'ru',
        ...
        'sub_category_id' => 132,
        'lang' => 'am',
        'name' => 'Վարսավիրական ծառայություններ'
        ],
        [
        'sub_category_id' => 132,
        'lang' => 'ru',

                                ...
                                <tr>
                                    {{-- <td width="33%" align="center"> --}}
                                        {{-- @php
                                            $iconPath = public_path(
                                                '/assets/user/icons/categories/' .
                                                ($task->sub_category->category->icon ?? 'it') . '.svg'
                                            );
                                            $embeddedIcon = $message->embed($iconPath);
                                        @endphp
                                    ...
                                    <td style="padding-left: 10px;">
                                     ...
                                     {{-- <td style="padding-left: 10px;">
                                        ...
                                        📍 {{ $task->location->translation->name }}<br>
                                     ...
                                     <td style="padding-left: 10px;">
                                        ...
                                        <span style="color: green;">Հասանելի</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        {{-- <div class="card-footer">
                          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 14px; color: #555; border-top: 1px solid #f1f1f1;">
                            <tr style="background-color: #f5f5f5;">
                                ...
                                <a href="#" style="color: #222; text-decoration: none; font-weight: 600;">Ссылка</a>
                                </td>
                            </tr>
                            </table>
                        </div> --}}

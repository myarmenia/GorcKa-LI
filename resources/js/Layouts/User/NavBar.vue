                ...
                <div id="navbar-collapse" class="navbar-res items-center justify-between w-full text-sm lg:flex lg:w-auto lg:order-1 group-focus:[.navbar-toggler]:block hidden">
                    <ul class="flex flex-col items-start mt-5 mb-10 font-medium lg:mt-0 lg:mb-0 lg:items-center lg:flex-row" id="navigation-menu">
                        <li class="py-5 lg:px-4">
                            <Link :href="route('welcome', { locale: $page.props.locale })" class="py-2.5 text-gray-800 font-medium leading-tight dark:text-gray-50"> {{useTrans('navbar.home')}} </Link>
                        ...
                        <li class="py-5 lg:px-4">
                            <Link :href="route('welcome', { locale: $page.props.locale })" class="py-2.5 text-gray-800 font-medium leading-tight dark:text-gray-50"> {{useTrans('navbar.jobs')}} </Link>

                        </li>
                        <li class="py-5 lg:px-4">
                            <Link :href="route('welcome', { locale: $page.props.locale })" class="py-2.5 text-gray-800 font-medium leading-tight dark:text-gray-50"> {{useTrans('navbar.specialists')}} </Link>

                        </li>
                        <li class="py-5 lg:px-4">
                            <Link :href="route('welcome', { locale: $page.props.locale })" class="py-2.5 text-gray-800 font-medium leading-tight dark:text-gray-50"> {{useTrans('navbar.categories')}} </Link>

                        </li>
                        <li class="py-5 lg:px-4">
                            <Link :href="route('welcome', { locale: $page.props.locale })" class="py-2.5 text-gray-800 font-medium leading-tight dark:text-gray-50"> {{useTrans('navbar.contact')}} </Link>

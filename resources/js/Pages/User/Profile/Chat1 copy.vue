...
<template>
    <Index>
        ...
        <template #content>
            <div class="flex">
                <div class="flex">
                    <div class="chat-leftsidebar lg:w-[380px] group-data-[theme-color=green]:bg-green-500/20  shadow overflow-y-hidden mb-[80px] lg:mb-0 group-data-[theme-color=green]:dark:bg-zinc-700">
                        <div>
                            <div class="tab-content active">
                                ...
                                <div>
                                    <div class="p-2">
                                        ...
                                        <div class="py-1 mt-5 mb-5 rounded group-data-[theme-color=green]:bg-green-50 group-data-[theme-color=green]:dark:bg-zinc-600 ">
                                            <span class="group-data-[theme-color=green]:bg-green-50  pe-1 ps-3  group-data-[theme-color=green]:dark:bg-zinc-600 " id="basic-addon1">
                                                <i class="text-lg text-gray-400 uil uil-search search-icon dark:text-gray-200"></i>
                                            </span>
                                            <input type="text" class="border-0  group-data-[theme-color=green]:bg-green-50  placeholder:text-[14px] focus:ring-offset-0 focus:outline-none focus:ring-0  group-data-[theme-color=green]:dark:bg-zinc-600 placeholder:text-gray-400" placeholder="Search messages or users" aria-label="Search messages or users" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                                                    ...
                                                                    <li>
                                                                        <div data-tw-accordion="collapse">
                                                                            <div class="text-gray-700 accordion-item dark:text-gray-300">
                                                                                <h6>
                                                                                    <button type="button" class="flex items-center justify-between w-full px-4 py-2 font-medium text-left accordion-header  group group-data-[theme-color=green]:bg-green-500/20 active">
                                                                                ...
                                                                                <div class="accordion-body block">
                                                                                    <div class="">
                                                                                        <div class="mt-2 p-2 room">
                                                                                            <a href="#">
                                                                                                <div class="relative flex">
                                                                                                    <div class="relative self-center ltr:mr-3 rtl:ml-3">
                                                                                                        <img src="/assets/user/images/avatar-3.jpg" class="rounded-full w-9 h-9" alt="">
                                                                                        ...
                                                                                        <div class="mt-2 p-2 room active-room">
                                                                                            <a href="#">
                                                                                                <div class="relative flex">
                                                                                                    <div class="relative self-center ltr:mr-3 rtl:ml-3">
                                                                                                        <img src="/assets/user/images/avatar-3.jpg" class="rounded-full w-9 h-9" alt="">
                    ...
                    <div class="w-full overflow-hidden transition-all duration-150 bg-white user-chat dark:bg-zinc-800">
                        <div class="lg:flex">
                            ...
                            <div class="relative w-full overflow-hidden ">
                                        ...
                                        <div class="col-span-4 sm:col-span-4">
                                            <div class="flex items-center">
                                                ...
                                                <div class="rtl:ml-3 ltr:mr-3">
                                                    <img src="/assets/user/images/avatar-4.jpg" class="rounded-full h-9 w-9" alt="">
                                                </div>
                                                <div class="flex-grow overflow-hidden">
                                                    <h5 class="mb-0 truncate text-16 ltr:block rtl:hidden">
                                                        <a href="#" class="text-gray-800 dark:text-gray-50">Doris Brown</a>
                                                    ...
                                                    <h5 class="mb-0 truncate text-16 rtl:block ltr:hidden">
                                                        ...
                                                        <a href="#" class="text-gray-800 dark:text-gray-50">Doris Brown</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="fixed inset-0 z-50 overflow-hidden">
                                                        ...
                                                        <div class="flex items-center justify-center max-w-lg min-h-screen p-4 mx-auto text-center animate-translate">
                                                            <div class="relative w-full max-w-lg my-8 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl -top-10 dark:bg-zinc-700">
                                                                <div class=" group-data-[theme-color=green]:bg-green-50/50 /50  group-data-[theme-color=green]:dark:bg-zinc-600 ">
                                                                    <div class="p-4">
                                                                        <div class="p-6">
                                                                            <div class="p-4 text-center">
                                                                                <div class="mb-6">
                                                                                    <img src="/assets/user/images/avatar-4.jpg" alt="" class="w-24 h-24 mx-auto rounded-full">
                                                                                </div>
                                                ...
                                                <div>
                                                    <div class="flex gap-2 mb-2">
                                                        <div class="relative px-5 py-3 text-white rounded-lg ltr:rounded-bl-none rtl:rounded-br-none  group-data-[theme-color=green]:bg-green-500 0">
                                                            ...
                                                            <div class="before:content-[''] before:absolute before:border-[5px] before:border-transparent  group-data-[theme-color=green]:ltr:before:border-l-green-500 group-data-[theme-color=green]:ltr:before:border-t-green-500  group-data-[theme-color=green]:rtl:before:border-r-green-500 group-data-[theme-color=green]:rtl:before:border-t-green-500 ltr:before:left-0 rtl:before:right-0 before:-bottom-2"></div>
                                                        </div>
                                        ...
                                        <li class="clear-both py-4">
                                            <div class="relative inline-flex items-end mb-6 text-right ltr:rtl:float-left ltr:float-right rtl:float-left">
                                                <div class="order-3 mr-0 ltr:ml-4 rtl:mr-4">
                                                    <img src="/assets/user/images/avatar-1.jpg" alt="" class="rounded-full h-9 w-9">
                                                </div>
                                                                ...
                                                                <li class="relative inline-block mr-2">
                                                                    <div>
                                                                        <a class="inline-block m-1 popup-img" href="assets/images/small/img-1.jpg" title="Project 1">
                                                                            <img src="/assets/user/images/img-1.jpg" alt="" class="border rounded h-28">
                                                                        </a>
                                                                    </div>
                                                                ...
                                                                <li class="relative inline-block mr-2">
                                                                    <div>
                                                                        <a class="inline-block m-1 popup-img" href="assets/images/small/img-2.jpg" title="Project 2">
                                                                            <img src="/assets/user/images/img-2.jpg" alt="" class="border rounded h-28">
                                                                        </a>
                                                                    </div>
                                                                    <div class="absolute right-[10px] left-auto bottom-[10px]">
                                                        ...
                                                        <div class="relative order-2 px-5 py-3 text-gray-700 rounded-lg rounded-br-none bg-gray-50 dark:bg-zinc-700">
                                                            ...
                                                            <div class="p-2 mb-2 bg-white rounded dark:bg-zinc-800">
                                                                <div class="flex flex-wrap items-center gap-2 attached-file">
                                                                    <div class="flex items-center justify-center w-12 h-12 rounded  group-data-[theme-color=green]:bg-green-500/20 0/20 group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=red]:text-red-500">
                                ...
                                </div></div></div></div><div class="simplebar-placeholder" style="width: 1102px; height: 1264px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 452px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
                                            ...
                                            <div>
                                                <ul class="mb-0">
                                                    ...
                                                    <li class="inline-block">
                                                        <button type="submit" class="text-white border-transparent btn  group-data-[theme-color=green]:bg-green-500 0 group-data-[theme-color=violet]:hover:bg-violet-600 group-data-[theme-color=green]:hover:bg-green-600">
                            ...
                            <div class="user-profile-sidebar h-[100vh] bg-white shadow overflow-y-hidden mb-[85px] lg:mb-0 group-data-[theme-color=violet]:dark:bg-zinc-800 border-l-4 border-gray-50 dark:border-zinc-600 group-data-[theme-color=green]:dark:bg-zinc-700 group-data-[theme-color=red]:dark:bg-zinc-700 absolute xl:relative top-0 bottom-0" style="display: none;">
                                ...
                                <div class="p-6 text-center border-b border-gray-100 dark:border-zinc-600">
                                    <div class="mb-4">
                                        <img src="/assets/user/images/avatar-1.jpg" class="w-24 h-24 p-1 mx-auto border border-gray-100 rounded-full dark:border-zinc-800" alt="">
                                    </div>
                                        ...
                                        <div class="hidden bg-white border border-t-0 border-gray-100 accordion-body dark:bg-transparent dark:border-zinc-600">
                                            <div class="p-5">
                                                <div class="p-2 mb-2 border rounded border-gray-100/80 dark:bg-zinc-800 dark:border-transparent">
                                                    <div class="flex items-center">
                                                        <div class="flex items-center justify-center w-10 h-10 rounded ltr:mr-3  group-data-[theme-color=green]:bg-green-500/20 0/20 rtl:ml-3">
